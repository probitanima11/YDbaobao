...
public class CustomerDao extends JdbcDaoSupport {
	...
	public void createCustomer(Customer customer) {
		...
		getJdbcTemplate().update(sql, customer.getCustomerId(), customer.getCustomerName(),
				customer.getCustomerPassword(), customer.getCustomerPhone(), customer.getCustomerEmail(),
